...
if __name__ == "__main__":
    ...
    simulation = Simulate(config)
    simulation.run_loop()
    with open("configs/config_summer1_G36_reset") as f:
        config = json.load(f)
    print(config)
    simulation = Simulate(config)
    simulation.run_loop()    
    with open("configs/config_shoulder1_baseline") as f:
        config = json.load(f)
    print(config)
    simulation = Simulate(config)
    simulation.run_loop()
    with open("configs/config_shoulder1_SAT_reset") as f:
        config = json.load(f)
    print(config)
    simulation = Simulate(config)
    simulation.run_loop()    
    with open("configs/config_shoulder1_G36_reset") as f:
        config = json.load(f)
    print(config)
    simulation = Simulate(config)
    simulation.run_loop()    