...
model HeatPumpOnOffTesting
  ...
  Buildings.ThermalZones.EnergyPlus_9_6_0.ThermalZone zon(
    ...
    final nPorts=2)
    "Thermal zone model"
    annotation (Placement(transformation(extent={{58,32},{98,72}})));
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant TZonHea(k=273.15 + 24)
...
equation
  ...
  connect(pthp.port_Air_a2, zon.ports[1])
    annotation (Line(points={{24,-2},{76,-2},{76,32.9}},
                                                       color={0,127,255}));
  connect(pthp.port_Air_b2, zon.ports[2])
    annotation (Line(points={{24,-10},{80,-10},{80,32.9}},
                                                         color={0,127,255}));
  connect(con.y, zon.qGai_flow) annotation (Line(points={{22,40},{40,40},{40,62},
          {56,62}}, color={0,0,127}));
  connect(zon.TAir, modCon.TZon) annotation (Line(points={{99,70},{108,70},{108,
  ...
  connect(zon.TAir, TZonMea.u)
    annotation (Line(points={{99,70},{108,70},{108,68},{118,68}},
                                                color={0,0,127}));
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-140,
    ...
    __Dymola_Commands(file="Resources/HeatPumpOnOffTesting.mos"
        "Simulate and Plot"));
end HeatPumpOnOffTesting;
